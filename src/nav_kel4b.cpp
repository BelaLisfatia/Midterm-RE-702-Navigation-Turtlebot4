...
#include "irobot_create_msgs/msg/audio_note_vector.hpp" // Header file audio note
...
public:
    ...
    void send_goal(double x, double y, double theta)
    {
        ...
        client_ptr_->async_send_goal(goal_msg, send_goal_options); //Mengirim navigasi ke nav2 agar robot berjalan otonom
